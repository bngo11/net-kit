...
SRC_URI="https://www.wireshark.org/download/src/all-versions/wireshark-4.4.1.tar.xz -> wireshark-4.4.1.tar.xz"
KEYWORDS="*"
S="${WORKDIR}/${P/_/}"
...
src_install() {
	...
	doins "${BUILD_DIR}"/ws_version.h
	doins file.h
	doins cfile.h
	doins epan/register.h
	doins include/*.h
