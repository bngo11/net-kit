...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.7/tdesktop-6.3.7-full.tar.gz -> tdesktop-6.3.7-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.7/tsetup.6.3.7.tar.xz -> tsetup.6.3.7.tar.xz"
