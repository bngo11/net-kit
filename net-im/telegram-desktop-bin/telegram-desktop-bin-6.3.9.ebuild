...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.9/tdesktop-6.3.9-full.tar.gz -> tdesktop-6.3.9-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.3.9/tsetup.6.3.9.tar.xz -> tsetup.6.3.9.tar.xz"
