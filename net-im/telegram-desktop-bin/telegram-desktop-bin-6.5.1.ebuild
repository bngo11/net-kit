...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.1/tdesktop-6.5.1-full.tar.gz -> tdesktop-6.5.1-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.1/tsetup.6.5.1.tar.xz -> tsetup.6.5.1.tar.xz"
