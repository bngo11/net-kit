...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.0/tdesktop-6.5.0-full.tar.gz -> tdesktop-6.5.0-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.5.0/tsetup.6.5.0.tar.xz -> tsetup.6.5.0.tar.xz"
