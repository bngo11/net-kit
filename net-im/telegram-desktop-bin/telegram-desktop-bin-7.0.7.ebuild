...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.7/tdesktop-7.0.7-full.tar.gz -> tdesktop-7.0.7-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.7/tsetup.7.0.7.tar.xz -> tsetup.7.0.7.tar.xz"
