...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.9/tdesktop-7.0.9-full.tar.gz -> tdesktop-7.0.9-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.9/tsetup.7.0.9.tar.xz -> tsetup.7.0.9.tar.xz"
