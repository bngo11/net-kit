...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.2/tdesktop-7.0.2-full.tar.gz -> tdesktop-7.0.2-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v7.0.2/tsetup.7.0.2.tar.xz -> tsetup.7.0.2.tar.xz"
