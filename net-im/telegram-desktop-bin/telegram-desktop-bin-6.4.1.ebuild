...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v6.4.1/tdesktop-6.4.1-full.tar.gz -> tdesktop-6.4.1-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v6.4.1/tsetup.6.4.1.tar.xz -> tsetup.6.4.1.tar.xz"
