...
SRC_URI="https://github.com/telegramdesktop/tdesktop/releases/download/v7.2.5/tdesktop-7.2.5-full.tar.gz -> tdesktop-7.2.5-full.tar.gz
https://github.com/telegramdesktop/tdesktop/releases/download/v7.2.5/tsetup.7.2.5.tar.xz -> tsetup.7.2.5.tar.xz"
