...
IUSE="audit bluetooth +concheck connection-sharing debug dhcpcd elogind gnutls +gtk-doc +introspection iptables iwd psl libedit lto +nss nftables +modemmanager ofono ovs policykit ppp resolvconf selinux syslog teamd test +tools +vala +wifi"
RESTRICT="!test? ( test )"
...
src_configure() {
	local emesonargs=(
		...
		-Dsystemdsystemgeneratordir=false
