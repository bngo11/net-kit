...
EGO_SUM=(
	...
	"github.com/!azure/azure-sdk-for-go/sdk/storage/azfile v1.5.4/go.mod"
	...
	"github.com/!files-com/files-sdk-go/v3 v3.3.82/go.mod"
	"github.com/!i!b!m/go-sdk-core/v5 v5.21.2"
	"github.com/!i!b!m/go-sdk-core/v5 v5.21.2/go.mod"
	...
	"github.com/!puerkito!bio/goquery v1.11.0"
	"github.com/!puerkito!bio/goquery v1.11.0/go.mod"
	...
	"github.com/cloudinary/cloudinary-go/v2 v2.15.0/go.mod"
	...
	"github.com/internxt/rclone-adapter v0.0.0-20260331173834-036f908d0160/go.mod"
	...
	"github.com/lufia/plan9stats v0.0.0-20260216142805-b3301c5f2a88/go.mod"
	...
	"github.com/minio/minio-go/v7 v7.0.100/go.mod"
	...
	"github.com/oracle/oci-go-sdk/v65 v65.111.0/go.mod"
	"github.com/panjf2000/ants/v2 v2.11.5"
	"github.com/panjf2000/ants/v2 v2.11.5/go.mod"
	...
	"github.com/rclone/!proton-!a!p!i-!bridge v1.0.1"
	"github.com/rclone/!proton-!a!p!i-!bridge v1.0.1/go.mod"
	"github.com/rclone/go-proton-api v1.0.1"
	"github.com/rclone/go-proton-api v1.0.1/go.mod"
	...
	"github.com/t3rm1n4l/go-mega v0.0.0-20251120131202-6845944c051c/go.mod"
	...
	"golang.org/x/exp v0.0.0-20260212183809-81e46e3db34a/go.mod"
	"golang.org/x/image v0.0.0-20190227222117-0694c2d4d067/go.mod"
	"golang.org/x/image v0.0.0-20190802002840-cff245a6509b/go.mod"
	"golang.org/x/image v0.39.0"
	"golang.org/x/image v0.39.0/go.mod"
	...
	"golang.org/x/mobile v0.0.0-20260312152759-81488f6aeb60/go.mod"
	...
	"google.golang.org/genproto/googleapis/api v0.0.0-20260319201613-d00831a3d3e7/go.mod"
	...
	"storj.io/common v0.0.0-20260225132117-99155641c30a/go.mod"
	...
	"storj.io/uplink v1.14.0/go.mod"
)

go-module_set_globals

KEYWORDS="*"
SRC_URI="https://github.com/rclone/rclone/tarball/69a5376189ee1bbfdfc79a0aa74478f8de1eaa39 -> rclone-1.74.0-69a5376.tar.gz
https://direct.funtoo.org/b3/81/1b/b3811bd18a31d74040301bf8b156e7d4345bf837008e2bbbd46668e7e99fbf9e007b55af0a176f3e826272d5f2ea9a9d011011f04752c2cc834a9dc2cb7a46f2 -> rclone-1.74.0-funtoo-go-bundle-58c5508d24e03cc54f3c83dc193f07e28eb1d831d74bd8070c1458ef09758fed29eb01229e39c4ef8ba70f24584b8e4ba760197064cf728cc3030d0adecc6d95.tar.gz"
