...
SRC_URI="https://www.github.com/funtoo/dropbox-python-setup/tarball/1.1 -> dropbox-python-setup-1.1.tar.gz
	x86? ( https://edge.dropboxstatic.com/dbx-releng/client/dropbox-lnx.x86-187.3.5526.tar.gz -> dropbox-lnx.x86-187.3.5526.tar.gz )
	amd64? ( https://edge.dropboxstatic.com/dbx-releng/client/dropbox-lnx.x86_64-187.3.5526.tar.gz -> dropbox-lnx.x86_64-187.3.5526.tar.gz )
