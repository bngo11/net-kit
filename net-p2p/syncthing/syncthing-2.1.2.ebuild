...
EGO_SUM=(
	...
	"github.com/alecthomas/kong v1.15.0/go.mod"
	...
	"github.com/marbens-arch/gateway v1.1.2-0.20260308173556-c567cc04e7d4"
	"github.com/marbens-arch/gateway v1.1.2-0.20260308173556-c567cc04e7d4/go.mod"
	...
	"github.com/mattn/go-sqlite3 v1.14.45/go.mod"
	...
	"github.com/quic-go/go-ossfuzz-seeds v0.1.0/go.mod"
	"github.com/quic-go/quic-go v0.60.0"
	"github.com/quic-go/quic-go v0.60.0/go.mod"
	"github.com/rabbitmq/amqp091-go v1.11.0"
	"github.com/rabbitmq/amqp091-go v1.11.0/go.mod"
	...
	"golang.org/x/telemetry v0.0.0-20260610154732-fb80ec83bdd9/go.mod"
	...
	"modernc.org/libc v1.72.3/go.mod"
...
SRC_URI="https://github.com/syncthing/syncthing/tarball/9b63594106d94f5aa649beeea6f0161d4058f43a -> syncthing-2.1.2-9b63594.tar.gz
https://direct.funtoo.org/1a/6b/4c/1a6b4c4db613b27d7c050335e20a1de7ea9cc224b17bc3468becf6e270aa37bf443a8491151a5f8c982ec04b2c02738d6a73077386806877502f2448b46f4570 -> syncthing-2.1.2-funtoo-go-bundle-56ded9671adf0138b1d59157c21c54dba12f74a4f403d617666cc738e8cf37e54235da77ecb8b7d0dc151aeb4afbc6f64f3bd3ccd8489f2f4cf43cdc6c0a52a5.tar.gz"

LICENSE="Apache-2.0 BSD BSD-2 ISC MIT MPL-2.0 Unlicense"
SLOT="0"
KEYWORDS="*"
IUSE="tools"
S="${WORKDIR}/syncthing-syncthing-9b63594"
